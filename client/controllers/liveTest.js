//for runing test
myApp.controller('liveTestCtrl', ['$scope', '$interval' , '$rootScope', '$location', '$route',  '$routeParams', '$window', '$auth', 'Account', 'TestsApi',
  function($scope, $interval , $rootScope, $location, $route,  $routeParams, $window, $auth,Account, TestsApi) {
